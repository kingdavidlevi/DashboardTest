...
function Header(){
    ...
    return (
        <section className=" top-0  w-95% grid   items-center rounded-t-md  absolute h-22 bg-gray-100">
 <div className="flex items-center justify-end">
    <section className="relative ">
<input placeholder="Search" className="bg-white text-black text-sm pr-1 pl-11 cursor-pointer placeholder:text-sm placeholder:text-gray-300 w-80 outline-none rounded-md  h-11"/>
<img src={search} className="absolute h-5 w-5 left-3 text-sm top-3"/>
    ...
    <section className='h-9 ml-6 relative w-9 grid place-items-center rounded-full bg-green-300'>
