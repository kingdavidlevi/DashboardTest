...
function Wallet (){
    ...
    return(
        ...
        <section className=" mb-4 w-95% mt-10 ">
            <div className="bg-white px-5 cursor-pointer shadow-md rounded-md h-14 items-center flex justify-between" onClick={CreateNewWallet}>
            ...
            <div className="bg-white px-5 cursor-pointer mt-2 shadow-md rounded-md h-14 items-center flex justify-between" onClick={FundingCard}>
                <section className="flex items-center gap-3">
                <FaWallet className="greentext" />
            ...
            <div className="bg-white px-5 cursor-pointer mt-2 shadow-md rounded-md h-14 items-center flex justify-between" onClick={Sendmoney}>
                <section className="flex items-center gap-3">
